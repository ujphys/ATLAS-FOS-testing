...
define vl~ = ve~ vm~ vt~
define vl = ve vm vt
generate g g > h HIG=1 HIW=0 QED=0 QCD=0, (h > h2 h2, (h2 > Zp Zp , Zp > l+ l-),(h2 > Zp Zp, Zp > vl vl~))
output -f"""
...
settings_param_card = { "HIDDEN": { 'epsilon': '1e-4', #kinetic mixing parameter
                                 ...
                                 'mzdinput': <ZdMass_Gev>, #Zd mass
                                 'mhsinput': <scalarMass_Gev> }, #dark higgs mass
                     "HIGGS": { 'mhinput': <higgs_Mass_Gev> }, #higgs mass
                     "DECAY": { 'wzp':'Auto', 'wh':'67.92', 'wt':'Auto' } #auto-calculate decay widths and BR of Zp, H, t
                  }
...
#### Shower
evgenConfig.description="MadGraph Hidden Abelian Higgs Model (HAHM): gg -> HH -> ZdZdZdZd -> 8l (l=e,mu,nu) , with mZd=65GeV"
evgenConfig.keywords+=['exotic','BSMHiggs']
evgenConfig.contact = ['jingjing.pan@cern.ch']
